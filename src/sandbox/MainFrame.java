...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ChangeColorPanel.setBounds(430, 330, 250, 80);
        ...
        jRadioButton1.setText("Легкий");
        jRadioButton1.setName("minLevel"); // NOI18N
        MenuPanel.add(jRadioButton1);

        jRadioButton2.setText("Средний");
        jRadioButton2.setName("midLevel"); // NOI18N
        MenuPanel.add(jRadioButton2);

        jRadioButton3.setText("jRadioButton3");
        MenuPanel.add(jRadioButton3);
        ...
        MenuPanel.setBounds(430, 10, 250, 280);
...
//        controller.Move(4);
//        controller.MoveComp();
        controller.recursMove(4,1,0,0);
        controller.recursMove(-1, 2,GameController.getCurrentDif()-1, GameController.getCurrentDif()-1);
        controller.fieldcleaner();
...
//        controller.MoveComp();
    ...
    private void printGameStatus(int[] a) {
        ...
        } else if ( (a[0] >= (GameController.getCurrentDif()*GameController.getCurrentDif())/2)
               || (a[1]>= (GameController.getCurrentDif()*GameController.getCurrentDif())/2) ){
            if (a[0]>a[1]){GameStatusFieldText.setText("Вы уже победили, можно начать новую игру.\n"
                    + "Игрок : " + a[0] + "\n"
                    + "Опонент : " + a[1] + "\n"
                    + "Свободно полей : " + a[2]);}
            if(a[0]<a[1]){GameStatusFieldText.setText("Вы уже проиграли, можно начать новую игру.\n"
                    + "Игрок : " + a[0] + "\n"
                    + "Опонент : " + a[1] + "\n"
                    + "Свободно полей : " + a[2]);}
        } else{
